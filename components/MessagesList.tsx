...
export function MessagesList({ messages }: GuildMessageListProps) {
    return (<table style={{ width: "100%" }}>
        ...
        <tr>
            <th style={{ width: "1%", verticalAlign: "middle", textAlign: "right" }}><Forms.FormText>Group</Forms.FormText></th>
            <td><Input
        ...
        <tr>
            <th style={{ width: "1%", verticalAlign: "middle", textAlign: "right" }}><Forms.FormText>User</Forms.FormText></th>
            <td><Input
        ...
        <tr>
            <th style={{ width: "1%", verticalAlign: "middle", textAlign: "right" }}><Forms.FormText>Stream (group)</Forms.FormText></th>
            <td><Input
        ...
        <tr>
            <th style={{ width: "1%", verticalAlign: "middle", textAlign: "right" }}><Forms.FormText>Stream (user)</Forms.FormText></th>
            <td><Input
